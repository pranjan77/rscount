...
sub new
{
    ...
    my $self = {
	client => rscount::rscountClient::RpcClient->new,
	url => $url,
	headers => [],
    };
...
<pre>
$workspace_name is a rscount.workspace_name
$contigset_id is a rscount.contigset_id
$return is a rscount.CountContigsResults
...
sub _validate_version {
    ...
    if ($sMinor > $cMinor) {
        warn "New client version available for rscount::rscountClient\n";
    }
    if ($sMajor == 0) {
        warn "rscount::rscountClient version is $svr_version. API subject to change.\n";
    }
}
...
package rscount::rscountClient::RpcClient;
